...
print("CSC-466 Final Project - Training Script")
print("="*60)
...
# Select features (use what you already have)
feature_cols = [
    'price_mwh',
    'gpu_utilization_pct',
    'active_jobs',
...
split_idx = int(len(df) * 0.75)  # 75% train, 25% test
...
print("\n✅ TRAINING COMPLETE!")
print(f"Next step: Run 'python evaluate_models.py' to create visualizations")