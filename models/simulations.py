...
TOTAL_GPUS = 10000
GPU_POWER_WATTS = 300  # Watts per GPU
SIMULATION_HOURS = 24  # Simulate 24 hours
...
class GPUClusterSimulator:
    ...
    def generate_current_conditions(self, hour):
        ...
        price = max(price, 15)  # Floor price
    ...
    def display_hour(self, hour_num, hour, price, util, jobs, cost, 
        ...
        is_actually_efficient = jpd > 124  # Your median threshold
...
try:
    for hour in range(SIMULATION_HOURS):
        ...
        time.sleep(0.5)  # Pause between hours for readability
