...
# =============================================================================
# 1. Find BEST daytime hours that beat WORST nighttime hours
# =============================================================================
...
# =============================================================================
# 2. Count how many daytime hours beat average nighttime
# =============================================================================
...
# =============================================================================
# 3. Show specific hours where daytime > nighttime
# =============================================================================
...
# =============================================================================
print("\n\n[4] REAL COST SAVINGS EXAMPLE")
print("-"*80)

# Pick a specific efficient daytime hour
efficient_day_hour = daytime[daytime['is_efficient_time'] == 1].iloc[0]
# Pick a specific inefficient nighttime hour  
