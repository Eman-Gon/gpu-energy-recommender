"""
Spike Analysis - Daytime Efficiency Patterns
"""
...
print(f"Daytime hours (9am-5pm): {len(daytime)} total")
...
print("INEFFICIENT Daytime Hours:")
...
print("Efficiency by hour (9am-5pm):")
...
print("Efficiency by day of week:")
...
print(f"If a daytime hour is efficient, probability next hour is also efficient: {persistence:.1%}")
if persistence > 0.6:
...
print("Top 5 most efficient daytime hours:")
...
if price_diff > 10:
    ...
    print("WEAK PATTERN: Differences are small")
...
if persistence > 0.6:
    ...
    print(f"LOW CLUSTERING: {persistence:.1%} persistence")
...
if efficiency_at_best_hour > 0.6:
    ...
    print(f"NO HOUR-OF-DAY PATTERN: Best hour is only {efficiency_at_best_hour:.1%} efficient")